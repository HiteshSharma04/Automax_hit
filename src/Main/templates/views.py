...
def landing_view(request):
    ...
    return render(request, "views/main.html", {"new" : "Done!"})
...
def inquire_listing_using_email(request, id):
    ...
    try:
        ...
        emailMessage = f'Hii {listing.seller.user.username}, {request.user.username} is interested in your {listing.model} listing on AutoMax!'
